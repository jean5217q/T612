...
class Flight_Form_Page extends Component {
  state = {
    carrier: '',
    t_Number: '',
    seat: '',
  ...
  bundleInput = () => {
    ...
    let obj = {
      ...
      time: new Date(depart_t),
      sub: [
        { title: 'airline', value: carrier },
        { title: 'a_number', value: t_Number },
      ...
      <div>
        <div className='add-select-group'>
          <div className='add-select-input-wrap'>
            ...
            <div className='add-select-input'>{txt['content']['flight'][lang]}</div>
          </div>
          <div className='add-select-input-wrap'>
            <label className='add-select-label'>{txt['content']['airline'][lang]}</label>
            <input
          ...
          <div className='add-select-input-wrap'>
            <label className='add-select-label'>{txt['content']['a_number'][lang]}</label>
            <input
              className='add-select-input'
              type='input'
              placeholder={txt['content']['optional'][lang]}
...
export default Flight_Form_Page