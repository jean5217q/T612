    ...
    return (
      <div className='select-country-panel sm'>
        ...
        <div className='country-selectbar-block'>
          <label className={`country-selectbar-title lang-${lang}`}>{country_text['state'][lang]}</label>
          <div className='select-country-style'>
            <select
              className='select-country-origin'
        ...
        {/* AREA */}
        <div className='country-selectbar-block'>
          <label className={`country-selectbar-title lang-${lang}`}>{country_text['area'][lang]}</label>
          <div className='select-country-style'>
            <select
              className='select-country-origin'
        ...
        {/* COUNTRY */}
        <div className='country-selectbar-block'>
          <label className={`country-selectbar-title lang-${lang}`}>{country_text['country'][lang]}</label>
          <div className='select-country-style'>
            <select
        ...
        <div className='country-selectbar-block'>
          <div
            className='country-selectbar-add-btn'
            onClick={() => addToCountryList(current_country)}>{btn['add'][lang]}</div>
        </div>
      </div>
    )
  }
